   ...
   public boolean onOptionsItemSelected(MenuItem item) {
      ...
      switch (item.getItemId()) {
         ...
         case R.id.BackgroundImage:
            doodleView.setBackground(0);
            doodleView.setBackgroundResource(R.drawable.harambe);
             doodleView.bringToFront();
            return true; // consume the menu event
         case R.id.BackgroundRed:
            doodleView.changeColorBackground(255, 255, 0, 0);
            return true; // consume the menu event
         case R.id.BackgroundGreen:
            doodleView.changeColorBackground(255, 0, 255, 0);
            return true; // consume the menu event
         case R.id.BackgroundBlue:
            doodleView.changeColorBackground(255, 0, 0, 255);
            return true; // consume the menu event
