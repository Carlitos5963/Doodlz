...
public class DoodleView extends View {
   ...
   //private final Map<Integer, Path> redoMap = new HashMap<>();
  ...
  /* public void undo(){
      ...
      if(!previousPointMap.isEmpty()){
        // previousPointMap.remove();
         invalidate();
      }
   } */
   ...
   public void changeColorBackground(int a, int r, int g, int b){
      bitmapCanvas.drawARGB(a, r, g, b);
   }
